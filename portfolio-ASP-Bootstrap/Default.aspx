...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <section class="seccion-foto-y-presentacion py-5">
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-xl-4 col-12 text-center mb-4 mb-xl-0">
                    <img class="foto-de-perfil" width="200" height="200"
                        src="https://upload.wikimedia.org/wikipedia/commons/7/7c/Profile_avatar_placeholder_large.png"
                        alt="Retrato">
                </div>
                <div class="col-xl-8 col-8">
                    <p>
                        Estudiante de programación autodidacta, con dos años de Ing. en Sistemas y varios cursos de
                        programación basados en el lenguaje C# junto con .NET framework.
                    </p>
                    <div class="d-flex gap-3">
                        <a href="" class="icon-link-redes">
